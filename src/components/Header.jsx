...
function Header() {
  return (
    <header className="w-full p-4 md:p-6 flex justify-between items-center border-b border-zinc-800">
      <h1 className="text-base text-zinc-100 font-semibold">useTabAway</h1>
      <a href="https://github.com/azlibdar/use-tab-away" title="Get Source Code" className=" no-underline flex justify-center items-center">
